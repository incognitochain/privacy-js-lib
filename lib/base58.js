...
console.log("Version: ", CheckDecode(CheckEncode([93,92,91,90],0x00)).version, "\nBytes Decoded: ",CheckDecode(CheckEncode([93,92,91,90],0x00)).bytesDecoded);

module.exports = {CheckEncode, CheckDecode}