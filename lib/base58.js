...
function checkSumFirst4Bytes(data){
    var res = common.DoubleHashBytesToBytes(data);
    return res.slice(0,4);
}

// console.log("Version: ", CheckDecode(CheckEncode([0,92,91,255],0x00)).version, "\nBytes Decoded: ",CheckDecode(CheckEncode([0,92,91,255],0x00)).bytesDecoded);

module.exports = {CheckEncode, CheckDecode, checkSumFirst4Bytes};