    ...
    while (n > 1) {
      ...
      const thread = spawn(function (input) {
        return new Promise(resolve => {
          ...
          // console.log(gi.getX().toString(), gi.getY().toString())
          // console.log(gnPrime.getX().toString(), gnPrime.getY().toString())
          // console.log(hi.getX().toString(), hi.getY().toString())
          // console.log(hnPrime.getX().toString(), hnPrime.getY().toString())
          // console.log(x.toString())
          // console.log(xInverse.toString())

          let GPrime = gi.mul(xInverse).add(gnPrime.mul(x));
          console.log("Compute:------", GPrime.getX().toString(), GPrime.getY().toString());
          let HPrime = hi.mul(x).add(hnPrime.mul(xInverse));

          // console.log([...HPrime.compress()])
          let result = [[...GPrime.compress()], [...HPrime.compress()]]
          resolve(result);
        })
      });
      ...
      for (let i = 0; i < nPrime; i++) {
        ...
        console.log("Decompress:------", GPrime[i].getX().toString(), GPrime[i].getY().toString());
      ...
      // console.log(G[i].getX().toString(), G[i].getY().toString())
      // console.log(G[i+nPrime].getX().toString(), G[i+nPrime].getY().toString())
      // console.log(H[i].getX().toString(), H[i].getY().toString())
      // console.log(H[i+nPrime].getX().toString(), H[i+nPrime].getY().toString())
      // console.log(x.toString())
      // console.log(xInverse.toString())
      // GPrime[i] = G[i].mul(xInverse).add(G[i + nPrime].mul(x));
      // console.log("Method 2:------", GPrime[i].getX().toString(), GPrime[i].getY().toString());
