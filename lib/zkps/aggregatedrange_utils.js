...
var aggparams  = require("./aggregaterangeparams");
...
function CalculateRMRP(aR, sR, y, zTimesTwo, z, x ) {
    ...
    return VectorAdd(HadamardProduct(y, VectorAdd(VectorAddScalar(aR, z), ScalarVectorMul(sR, x))), zTimesTwo)
}
...
VectorAdd,HadamardProduct,DeltaMRP,InnerProduct,CalculateLMRP, CalculateRMRP,InnerProductProof};
//
