...
class ComZeroWitness {
    ...
    prove(){
        ...
        return new ComZeroProof(this.commitmentValue, this.index, PedCom.CommitAtIndex(new common.BigInt(0), sRnd, this.index).compress(), sRnd.toArray('be',ec.BigIntSize))
