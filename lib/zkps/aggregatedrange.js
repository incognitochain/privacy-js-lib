...
class AggregatedRangeWitness {
  ...
  async prove() {
    ...
    await sleep(1000);
    // if (isWASMRunned == true && typeof(aggregatedRangeProve) != "undefined"){
    ...
    for (let i = 0; i < numValue; i++) {
      // console.log("N: ", p256.n.toString());
      // console.log("this.values[i]: ", this.values[i].toString());

      // if (this.values[i].cmp(p256.n) === 1){
      //   console.log("this.values[i].cmp(N) === 1");
      // }
