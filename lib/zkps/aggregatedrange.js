...
class AggregatedRangeProof{
    ...
    // IsSafe(){
    //     console.log(this.A.isSafe());
    //     console.log(this.S.isSafe());
    //     console.log(this.T1.isSafe());
    //     console.log(this.T2.isSafe());
    // }
    Print(){
        console.log(this.A.getX().toString(10), this.A.getY().toString(10));
        console.log(this.S.getX().toString(10), this.S.getY().toString(10));
        console.log(this.T1.getX().toString(10), this.T1.getY().toString(10));
        console.log(this.T2.getX().toString(10), this.T2.getY().toString(10));
        console.log(this.tauX.toString(10));
        console.log(this.tHat.toString(10));
        console.log(this.mu.toString(10));
    }
    Bytes(){
        let l = 1;
        ...
        for (let i=0;i<this.cmsValue.length;i++){
            ...
            // console.log(this.cmsValue[i].getX().toString(10));
            // console.log(this.cmsValue[i].getY().toString(10));
            // console.log(this.cmsValue[i].compress());
            // console.log(Curve.isOnCurve(this.cmsValue[i]));
