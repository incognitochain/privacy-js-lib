...
async function TestTx() {
    ...
    let res = await GetOutputCoin(keyWallet.KeyWallet.base58CheckSerialize(constantsWallet.PaymentAddressType), keyWallet.KeyWallet.base58CheckSerialize(constantsWallet.ReadonlyKeyType));
    console.log('res: ', res);
