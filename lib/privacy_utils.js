...
function hashSha3BytesToBytes(data) {
  let temp = String.fromCharCode.apply(null, new Uint8Array(data));
  let result = new SHA3(256).update(temp, 'utf8');
...
function TestUtil() {
  let temp = new Uint8Array([97 ,115, 100, 97, 115, 100, 102]);
  var a = hashSha3BytesToBytes(temp)
  console.log([...a])
}
