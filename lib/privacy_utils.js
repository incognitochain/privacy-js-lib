...
function RandInt(n=constants.BigIntSize) {
...
function IntToByteArr(n) {
    ...
    // return 2-byte array in decimal
}
...
// joinArray joins dst into src, return src
function joinArray(src, dst) {
    var res = [];
    // for (var i = 0; i < dst.length; i++) {
    //     src.push(dst[i]);
    // }

    // src.set(dst, src.length);
...
module.exports = {RandInt, AddPaddingBigInt, ByteArrToInt, IntToByteArr , IsPowerOfTwo, paddedAppend,
...
// }
// bytesArr = IntToByteArr(300)
// console.log(bytesArr)
// k = ByteArrToInt(bytesArr)
// console.log(k)
