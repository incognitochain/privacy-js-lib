...
async function TestTx() {
    ...
    paymentInfos[0] = new key.PaymentInfo(receiverKeyWallet1.KeySet.PaymentAddress, 23);

    let res = prepareInputForTx("", paymentInfos);

    let tx = new Tx();
    tx.init(res.senderKeySet.PrivateKey, paymentInfos, res.inputCoins, 0, true, null, null, null);
