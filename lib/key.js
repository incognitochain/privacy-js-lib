...
class PublicKey {
    ...
    constructor(spendingKey){
        var spendingKeyInt = new common.BigInt(spendingKey, 10, 'be')
        var pk = ec.Curve.g.mul(spendingKeyInt);
...
var hash1 = common.HashBytesToBytes(seed)
var hash2 = common.HashBytesToBytes(hash1)
