...
class SchnPrivKey { 
    ...
    GetPublicKey(GGenerator, HGenerator) {
        var G = ec.Curve.curve.decompress(GGenerator);
        var H = ec.Curve.curve.decompress(HGenerator);
...
class SchnPubKey {
    constructor(publicKeyBytesArrays){
        this.PK = ec.Curve.curve.decompress(publicKeyBytesArrays.slice(0, ec.CompressPointSize));
        this.G = ec.Curve.curve.decompress(publicKeyBytesArrays.slice(ec.CompressPointSize, ec.CompressPointSize*2));
        this.H = ec.Curve.curve.decompress(publicKeyBytesArrays.slice(ec.CompressPointSize*2, ec.CompressPointSize*3));
    }
