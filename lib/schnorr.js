...
class SchnPrivKey { 
    ...
    GetPublicKey(GGenerator, HGenerator) {
        ...
        var res = new Uint8Array(constants.CompressPointSize*3);
    ...
    Sign(data){
        ...
        var res = new Uint8Array(constants.BigIntSize*3);
...
class SchnPubKey {
    ...
    Verify(signaturesBytesArrays, data) {
        var E = new common.BigInt(signaturesBytesArrays.slice(0, constants.BigIntSize), 10, 'be');
        var S1 = new common.BigInt(signaturesBytesArrays.slice(constants.BigIntSize, 2*constants.BigIntSize), 10, 'be');
        var S2 = new common.BigInt(signaturesBytesArrays.slice(constants.BigIntSize*2, 3*constants.BigIntSize), 10, 'be');
...
function Hash(point, bytes){
    var b = new Uint8Array(constants.BigIntSize*2 + bytes.length);
